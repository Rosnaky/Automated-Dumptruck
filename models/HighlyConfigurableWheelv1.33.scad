...
tireID         = 101.6;    // Internal diameter (ID) -- How wide is the inside opening? 
...
spaceBetweenTires = 3;            // For o-rings/v-grooves, the space between each tire, if more than one 
...
spokeStyle        = "diamond";   // none, biohazard, circle, circlefit, diamond, line, rectangle, spiral, fill
...
innerCircleDiameter  = 40;    // The diameter of the solid inner circle under the hub, or zero for none. 
...
shaftDiameter        = 6.2;          // The diameter of the motor shaft
shaftFlatDiameter    = 5.8;          // The diameter of the motor shaft at the flat, or shaftDiameter for no flat.
